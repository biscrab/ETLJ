...
const Kanji: NextPage<{}> = () => {
    ...
    return(
        <S.Body>
            ...
            <S.Comment>한자(漢字): 표어문자(표의문자). 주로 실질형태소를 표기할 때 쓴다.</S.Comment>
            <S.Comment>일본에서 한자를 읽는 방법은 크게 음독(音読み)과 훈독(訓読み)으로 나뉜다. </S.Comment>
            <S.Comment>음독은 일본 한자음으로 한자를 읽는 것이며, 일본 한자음은 유입된 시기별로 한음, 오음, 당음 등으로 나뉜다.</S.Comment>
        </S.Body>
    )
}
